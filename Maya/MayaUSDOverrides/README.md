...
description: Maya USD - I wrote a pipeline to allow for set dressing overrides to be published down-pipe while leaving the original USD untouched. But, there are some quirks
---
