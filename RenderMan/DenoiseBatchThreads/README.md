...
description: Pixar's PhotoRealistic RenderMan 25+ denoise_batch does not provide an arg to set the number of threads when denoising images. However, there is a workaround.
---
